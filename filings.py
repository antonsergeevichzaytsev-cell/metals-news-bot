...
def parse_verdict(text):
    ...
    28.07: чистим пунктуацию и у первого слова, не только у всей строки —
    "да, полезно" раньше не матчился, потому что rstrip чистил хвост
    ВСЕЙ строки, а запятая после "да" оставалась. Это не смягчение
    правила "дословно" — по-прежнему точное совпадение со списком слов,
    просто пунктуация вокруг слова больше не считается частью слова."""
